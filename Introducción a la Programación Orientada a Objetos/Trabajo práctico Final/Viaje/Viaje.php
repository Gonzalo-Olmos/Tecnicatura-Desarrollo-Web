...
class Viaje
{
     ...
     * teniendo en cuenta de que si hay espacio en la coleccion segun la cantidad maxima de pasajeros
     */
    ...
    /**
     * Metodo que retorna solo la cantidad de pasajeros existentes en el arreglo, sin contar las posiciones vacias.
     *@param array $coleccionPasajeros
     *@return int pasajeros existentes
     */
    function cantidadDePasajeros($coleccionPasajeros){
        $cont=0;//variable contadora
        for ($i=0; $i < count($coleccionPasajeros); $i++) { 
            $espacioDeColeccion = $coleccionPasajeros[$i];
            if ($espacioDeColeccion == null) {
             $cont++;
            }
        }
        return $cont;
