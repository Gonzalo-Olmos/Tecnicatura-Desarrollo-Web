<?php
/**
 * Este modulo recibe por parámetro un número de 4 cifras y encripta dicho número
 ...
 */
 ...
 function encripta($num){
   ...
   /**
    * Este Módulo recibe por parámetro un número entero de cuatro cifras encriptado y lo desencripta
    *@param int $numE
    *@param int
    */
    ...
    */
     echo("Por favor ingrese un numero de 4 dígitos a encriptar:");
     $numero = trim(fgets(STDIN));
     
    //utilización al modulo 'encripta'
    $numeroEncriptado = encripta($numero);
    echo("El Numero que ingresó tiene un valor encriptado de: ". $numeroEncriptado. " \n");

    //utilización modulo 'desencripta'
    echo("Ingrese el número encriptado para ser desencriptado: \n");
